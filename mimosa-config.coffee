...
exports.config = {
  ...
  compilers:
    ...
    template:
      compileWith: "html"                                    # Other ops:"dust","jade","hogan","underscore","lodash","html","none".
                                                                     # "none" assumes you aren't using any micro-templating solution.
      extensions: ["template"]                            # list of extensions to compile
    ...
    css:
      compileWith: "less"                   # Other options: "none", "less", "stylus".  "none" assumes you are coding pure CSS and
                                              # the copy config will move that over for you.  More compilers to come.
      extensions: ["less"]          # list of extensions to compile
